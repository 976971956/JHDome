...
#import "TJQDatabaseManager.h"
//表名
#define TJQTable @"TJQTable"
@implementation TJQDatabaseManager
{
    //数据库操作对象
    FMDatabase *db;
}
...
{
    static TJQDatabaseManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[TJQDatabaseManager alloc] init];
    });
    return instance;
}
